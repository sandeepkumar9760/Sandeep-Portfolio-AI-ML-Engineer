...
const TechStack = () => {
  ...
  return (
    <div className="techstack">
      <h2> My Techstack</h2>
      <p style={{ textAlign: "center", color: "#ccc", maxWidth: "800px", margin: "0 auto", fontSize: "1.2rem", zIndex: 10, position: "relative" }}>
        <b>Languages:</b> C++, Python <br/>
        <b>Databases:</b> MySQL, MongoDB, PostgreSQL, Firebase, DynamoDB <br/>
        <b>Frameworks:</b> Django, Flask, FastAPI <br/>
        <b>Tools:</b> Git, Vercel, Figma, Ubuntu, AWS, GenAI, Power BI, Excel
      </p>
